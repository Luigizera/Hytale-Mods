...
public class VitalityComponent implements Component<EntityStore> {
    ...
    public VitalityComponent(VitalityComponent other) {
        this.level = other.level;
        this.perks = other.perks;
    }

    public static void setComponentType(ComponentType<EntityStore, VitalityComponent> type) {
        TYPE = type;
    }

    public static ComponentType<EntityStore, VitalityComponent> getComponentType() {
        return TYPE;
    }
    ...
    public BigDecimal getDefaultExp() {
        return new BigDecimal(BASE_MULTIPLIER).multiply(new BigDecimal(LevelComponent.MULTIPLIER));
    }
    ...
    private boolean isPerkValid(int FLAG_ID) {
        return perks != null
                ...
                && FLAG_ID >= 0
                && FLAG_ID < PerkId.VITALITY_CURRENT_PERK_COUNT;
    }
    ...
    public Component<EntityStore> clone() {
        return new VitalityComponent(this);
    }

    static {
        CODEC = BuilderCodec.builder(VitalityComponent.class, VitalityComponent::new)
