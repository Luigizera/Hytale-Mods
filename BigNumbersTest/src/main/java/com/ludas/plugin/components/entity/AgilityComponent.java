...
public class AgilityComponent implements Component<EntityStore> {
    ...
    public static final String BASE_CRIT_CHANCE = "0.001";
    public static final String BASE_CRIT_DAMAGE = "0.5";
    ...
    public String getCritChance() {
        return new BigDecimal(BASE_CRIT_CHANCE).multiply(new BigDecimal(this.level.getLevel())).toString();
    }

    public String getCritDamage() {
        return new BigDecimal(BASE_CRIT_DAMAGE).add(new BigDecimal(this.level.getLevel()).divide(new BigDecimal("100"))).toString();
    }
