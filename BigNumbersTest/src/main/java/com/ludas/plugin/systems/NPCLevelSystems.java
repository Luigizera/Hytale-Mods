    ...
    public static class NPCSpawnSystem extends RefSystem<EntityStore> {
        ...
        public void onEntityAdded(@NonNullDecl Ref<EntityStore> ref,
            ...
            if(level == null) {
                ...
                commandBuffer.putComponent(ref, LevelComponent.getComponentType(), new LevelComponent(new BigInteger(Integer.toString(randLevel))));
        ...
        public void handle(int index, @Nonnull ArchetypeChunk<EntityStore> archetypeChunk,
            ...
            if (damage.getSource() instanceof Damage.EntitySource entitySource) {
                ...
                if(level != null) {
                    ...
                    float dmg = damage.getAmount() * (l / 10f);
