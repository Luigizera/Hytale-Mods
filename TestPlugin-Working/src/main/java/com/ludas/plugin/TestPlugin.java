...
import com.ludas.plugin.packet.PlayerPacketTracker;
...
public class TestPlugin extends JavaPlugin {
    ...
    protected void setup() {
        ...
        Perk.MAP_CODEC.register(PoisonPerk.ID, PoisonPerk.class, PoisonPerk.CODEC);
        Perk.MAP_CODEC.register(StatusPerk.ID, StatusPerk.class, StatusPerk.CODEC);
    ...
    private void registerEntities() {
        ...
        var playerLevel = entityRegistry.registerComponent(LevelComponent.class, "LevelComponent", LevelComponent.CODEC);
